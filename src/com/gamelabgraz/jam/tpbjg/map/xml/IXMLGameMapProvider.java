...
public interface IXMLGameMapProvider {
  ...
  /**
   * Returns a {@link Collection} of Game maps loaded from given file <br>
   * file paramater may be a single file or a directory
   * 
   * @param file
   *          given file or directory with level xmls
   * @return {@link Collection} with {@link IGameMap} objects
   * 
   ...
   */
  Collection<IGameMap> provide(final File file) throws FileNotFoundException, IOException;
